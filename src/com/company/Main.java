...
class write implements Runnable
{
    ...
    public void run() {
        try{
            FileOutputStream fout=new FileOutputStream("\"C:\\Users\\SAKTHI SASI VELAR KP\\Desktop\\hotelManagement.txt\"");
...
public class Main {
    public static void main(String[] args){
        ...
        try
        {
            File f = new File("\"C:\\Users\\SAKTHI SASI VELAR KP\\Desktop\\hotelManagement.txt\"");
            if(f.exists())
            {
